...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (UserRole <= Role)
      return message.channel.send(
        `I Can't Ban That Member Because That Member Has Role Position Is Higher Than My Role Or Same Role As You!`
      );

    if (BotRole <= Role)
      return message.channel.send(
        `I Can't Ban That Member Because That Member Has Role Position Is Higher Than My Role Or Same Role As Me!`
      );
